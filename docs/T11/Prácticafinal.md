...
- **router/** – Contiene la definición del ruter, incluyendo el `index.ts` que incluye las rutas y la carpeta con los loaders.
- **layout/** – Almacena los diferentes componentes de diseño.
- **pages** - Incluyendo los componentes que renderizan las rutas.
- **components/** – Incluye componentes atómicos, moleculares y organismos, organizados por **tipo** o **característica**. Todos los que no son páginas.
...
- **Componentes de Pagina/Ruta** – Páginas que definen diferentes vistas dentro de la aplicación.
...
- Un enlace al **repositorio de GitHub** que contenga el proyecto completo, e incluir al profe en el proeycto.
